...
var test_pre_xfmr PreXfmrFunc = func(inParams XfmrParams) error {
	var err error
	log.V(lvl.INFO).Info("Entering test_pre_xfmr:- Request URI path = ", inParams.requestUri)
...
var test_post_xfmr PostXfmrFunc = func(inParams XfmrParams) (map[string]map[string]db.Value, error) {
	...
	log.V(lvl.INFO).Info("Entering test_post_xfmr Request URI path = ", inParams.requestUri)
...
var test_sensor_type_tbl_xfmr TableXfmrFunc = func(inParams XfmrParams) ([]string, error) {
	...
	log.V(lvl.INFO).Info("test_sensor_type_tbl_xfmr inParams.uri ", inParams.uri)
	...
	log.V(lvl.INFO).Info("test_sensor_type_tbl_xfmr tblList= ", tblList)
	return tblList, nil
}
...
var YangToDb_test_sensor_type_key_xfmr KeyXfmrYangToDb = func(inParams XfmrParams) (string, error) {
	...
	log.V(lvl.INFO).Info("YangToDb_test_sensor_type_key_xfmr - inParams.uri ", inParams.uri)
	...
	log.V(lvl.INFO).Info("YangToDb_test_sensor_type_key_xfmr returns", sensor_type_key)
	return sensor_type_key, err
}
...
var DbToYang_test_sensor_type_key_xfmr KeyXfmrDbToYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	log.V(lvl.INFO).Info("DbToYang_test_sensor_type_key_xfmr rmap ", rmap)
	return rmap, err
}
...
var YangToDb_test_sensor_zone_key_xfmr KeyXfmrYangToDb = func(inParams XfmrParams) (string, error) {
	...
	log.V(lvl.INFO).Info("YangToDb_test_sensor_zone_key_xfmr - inParams.uri ", inParams.uri)
	...
	log.V(lvl.INFO).Info("YangToDb_test_sensor_zone_key_xfmr returns", sensor_zone_key)
	return sensor_zone_key, err
}
...
var DbToYang_test_sensor_zone_key_xfmr KeyXfmrDbToYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	log.V(lvl.INFO).Info("DbToYang_test_sensor_zone_key_xfmr rmap ", rmap)
	return rmap, err
}
...
var YangToDb_test_set_key_xfmr KeyXfmrYangToDb = func(inParams XfmrParams) (string, error) {
	...
	log.V(lvl.INFO).Info(" YangToDb_test_set_key_xfmr returns ", testSetKey)
...
var DbToYang_test_set_key_xfmr KeyXfmrDbToYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	log.V(lvl.INFO).Info("DbToYang_testsensor_type_key_xfmr rmap ", rmap)
	return rmap, err
...
var DbToYang_test_sensor_type_field_xfmr FieldXfmrDbtoYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	log.V(lvl.INFO).Info("DbToYang_test_sensor_type_field_xfmr - inParams.uri ", inParams.uri)
	...
	log.V(lvl.INFO).Info("DbToYang_test_sensor_type_field_xfmr returns ", result)
...
var DbToYang_test_set_name_field_xfmr FieldXfmrDbtoYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	log.V(lvl.INFO).Info("DbToYang_test_set_name_field_xfmr - inParams.uri ", inParams.uri)
	...
	log.V(lvl.INFO).Info("DbToYang_test_set_name_field_xfmrreturns ", result)
...
var YangToDb_exclude_filter_field_xfmr FieldXfmrYangToDb = func(inParams XfmrParams) (map[string]string, error) {
	...
	if exflt != nil {
		...
		log.V(lvl.INFO).Info("YangToDb_exclude_filter_field_xfmr ", res_map["exclude_filter"])
	}
	return res_map, err
...
var DbToYang_exclude_filter_field_xfmr FieldXfmrDbtoYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	log.V(lvl.INFO).Info("DbToYang_exclude_filter_field_xfmr", data, inParams.ygRoot)
	pathInfo := NewPathInfo(inParams.uri)
	...
	if ok {
		...
		if instOk {
			...
			if fldOk {
				...
				log.V(lvl.INFO).Infof("DbToYang_exclude_filter_field_xfmr - returning %v", result["exclude-filter"])
			} else {
				return nil, tlerr.NotFound("Resource Not Found")
			}
		} else {
			log.V(lvl.INFO).Infof("DbToYang_exclude_filter_field_xfmr - sensor instance %v doesn't exist", inParams.key)
		}
	} else {
		log.V(lvl.INFO).Infof("DbToYang_exclude_filter_field_xfmr - Table %v does not exist in db Data", tblNm)
	}
...
var YangToDb_test_set_type_field_xfmr FieldXfmrYangToDb = func(inParams XfmrParams) (map[string]string, error) {
	...
	log.V(lvl.INFO).Info("YangToDb_test_set_type_field_xfmr: ", inParams.ygRoot, " Xpath: ", inParams.uri, " Type: ", testSetType)
...
var DbToYang_test_set_type_field_xfmr FieldXfmrDbtoYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	result := make(map[string]interface{})
	data := (*inParams.dbDataMap)[inParams.curDb]
	log.V(lvl.INFO).Info("DbToYang_test_set_type_field_xfmr", data, inParams.ygRoot)
...
var DbToYang_test_set_description_field_xfmr FieldXfmrDbtoYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	var err error
	data := (*inParams.dbDataMap)[inParams.curDb]
	log.V(lvl.INFO).Info("DbToYang_test_set_description_field_xfmr", data, inParams.ygRoot)
	...
	log.V(lvl.INFO).Info("DbToYang_test_set_description_field_xfmr returning :", result)
	return result, err
}
...
var YangToDb_test_set_description_field_xfmr FieldXfmrYangToDb = func(inParams XfmrParams) (map[string]string, error) {
	...
	res_map := make(map[string]string)
	log.V(lvl.INFO).Info("YangToDb_test_set_description_field_xfmr called")
	if inParams.param == nil {
		return res_map, err
	}
	...
	log.V(lvl.INFO).Info("YangToDb_test_set_description_field_xfmr: ", res_map)
	return res_map, err
}
...
var YangToDb_test_port_bindings_xfmr SubTreeXfmrYangToDb = func(inParams XfmrParams) (map[string]map[string]db.Value, error) {
	...
	log.V(lvl.INFO).Info("YangToDb_test_port_bindings_xfmr: ", inParams.ygRoot, inParams.uri)
...
var DbToYang_test_port_bindings_xfmr SubTreeXfmrDbToYang = func(inParams XfmrParams) error {
	...
	log.V(lvl.INFO).Info("DbToYang_test_port_bindings_xfmr")
	...
	if isSubtreeRequest(targetUriPath, "/openconfig-test-xfmr:test-xfmr/interfaces") || isSubtreeRequest(targetUriPath, "/openconfig-test-xfmr:test-xfmr/interfaces/interface") {
		...
		if nil == intfSbt.Interface || (nil != intfSbt.Interface && len(intfSbt.Interface) == 0) {
			log.V(lvl.INFO).Info("Get request for all interfaces")
			...
			log.V(lvl.INFO).Info("Get request for specific interface")
		}
		...
		for ifName, ocIntfPtr := range intfSbt.Interface {
			log.V(lvl.INFO).Infof("Processing get request for %s", *ocIntfPtr.Id)
			if !trustIntf {
			...
			if !testSets.IsNil() {
				...
				if testSet.IsNil() || (!testSet.IsNil() && testSet.Len() == 0) {
					log.V(lvl.INFO).Infof("Get all Ingress Test Sets for %s", ifName)
					...
					for testSet, testSetData := range testSetTblMap {
						...
						if contains(ports, ifName) {
							...
							log.V(lvl.INFO).Infof("Port:%v TestSetName:%v TestSetype:%v ", ifName, testSetName, testSetTypeDbkeyComp)
					...
					log.V(lvl.INFO).Info("Get for specific Test Set")
				}
...
var Subscribe_test_port_bindings_xfmr SubTreeXfmrSubscribe = func(inParams XfmrSubscInParams) (XfmrSubscOutParams, error) {
	...
	pathInfo := NewPathInfo(inParams.uri)
	targetUriPath, _ := getYangPathFromUri(pathInfo.Path)
	log.V(lvl.INFO).Info("Subscribe_test_port_bindings_xfmr targetUriPath:", targetUriPath)
	result.isVirtualTbl = true
	log.V(lvl.INFO).Info("Returning Subscribe_test_port_bindings_xfmr")
	return result, err
}
...
func convertSonicTestSetTypeToOC(testSetType string) ocbinds.E_OpenconfigTestXfmr_TEST_SET_TYPE {
	...
	if "IPV4" == testSetType {
		...
		log.V(lvl.INFO).Infof("Unknown type %v", testSetType)
	}
...
var DbToYang_test_sensor_mode_key_xfmr SonicKeyXfmrDbToYang = func(inParams SonicXfmrParams) (map[string]interface{}, error) {
	...
	* db key contains the separator as well eg: "mode:test123:3545"
	 */
	log.V(lvl.INFO).Info("DbToYang_test_sensor_mode_key_xfmr: key", inParams.key)
	if len(inParams.key) > 0 {
		/*split id and mode */
	...
	log.V(lvl.INFO).Info("DbToYang_test_sensor_mode_key_xfmr: res_map - ", res_map)
	return res_map, nil
}
...
var YangToDb_sensor_a_light_sensor_key_xfmr KeyXfmrYangToDb = func(inParams XfmrParams) (string, error) {
	...
	log.V(lvl.INFO).Info("YangToDb_sensor_a_light_sensor_key_xfmr - inParams.uri ", inParams.uri)
	...
	log.V(lvl.INFO).Info("YangToDb_sensor_a_light_sensor_key_xfmr returns", light_sensor_key)
	return light_sensor_key, err
}
...
var DbToYang_sensor_a_light_sensor_key_xfmr KeyXfmrDbToYang = func(inParams XfmrParams) (map[string]interface{}, error) {
	...
	log.V(lvl.INFO).Info("DbToYang_sensor_a_light_sensor_key_xfmr rmap ", rmap)
	return rmap, err
}
...
func light_sensor_validate(inParams XfmrParams) bool {
	...
	log.V(lvl.INFO).Info("light_sensor_validate returning ", traversal_valid)
