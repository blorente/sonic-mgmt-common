...
func TestEmitJSON_sort_ipAddr4(t *testing.T) {
	...
	*/
	addrs := new(OpenconfigInterfaces_Interfaces_Interface_Subinterfaces_Subinterface_Ipv4_Addresses)
...
func TestEmitJSON_sort_ipAddr6(t *testing.T) {
	...
	*/
	addrs := new(OpenconfigInterfaces_Interfaces_Interface_Subinterfaces_Subinterface_Ipv6_Addresses)
